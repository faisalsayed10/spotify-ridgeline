    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <>
            ...
            <div className="mt-12 pt-8 border-t border-gray-100">
              <h3 className="text-lg font-medium text-gray-900 mb-4">
                Here&apos;s how your listening history will look
              </h3>
              <div className="flex gap-4">
        ...
        <footer className="mt-16 pt-8 border-t border-gray-100 text-center text-gray-400 text-sm">
          Built with Next.js and D3.js by <a href="https://x.com/faisal_sayed05" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">Faisal Sayed</a>. <a href="https://github.com/faisalsayed10/spotify-ridgeline" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700">Open Source</a>.
        </footer>
      </div>
    </div>
  );
